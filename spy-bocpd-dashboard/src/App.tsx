...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-bg overflow-hidden">
      ...
      <ControlBar
        defaults={{ ticker, start: '2016-01-01', end: TODAY, lambda: data.metadata.lambda ?? 250, threshold: data.metadata.threshold ?? 0.8 }}
        loading={loading}
      ...
      {loading && (
        <div className="absolute inset-0 z-50 bg-bg/80 flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-t2 text-sm font-mono">Running BOCPD algorithm…</div>
